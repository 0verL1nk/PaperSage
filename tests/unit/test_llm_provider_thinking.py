...
def _settings(*, enable_thinking: bool, reasoning_effort: str) -> AgentSettings:
    return AgentSettings(
        ...
        agent_routing_context_max_chars=2200,
        agent_routing_context_item_max_chars=180,
        agent_routing_context_reason_max_chars=120,
        agent_routing_context_roles_preview_count=3,
